    ...
    ***********************************-->
    <div class="nav-header">
      <a href="#" class="brand-logo">
        ...
        <h2 class="logo-abbr" style="color:#36c95f; font-weight:900">D</h2>
        <h2 class="brand-title" style="color:#36c95f; font-weight:900">anamon</h2>
      </a>
            ...
            <ul class="navbar-nav header-right">
              ...
              <li class="nav-item dropdown header-profile">
                <a class="nav-link" href="javascript:;" role="button" data-toggle="dropdown">
                  <img src="../images/avatar/2.png" width="20" alt=""/>
    ...
    <div class="deznav">
      <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
          ...
          <li class="{{ (request()->segment(1)=='nasabah') || (request()->segment(1)=='bunga')  ? 'active-no-child' : '' }}">
            <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              <i class="flaticon-381-network"></i>
              <span class="nav-text">Table Master</span>
            </a>
            <ul aria-expanded="false">
              <li><a href="{{Route('list-nasabah')}}">Table Nasabah</a></li>
              <li><a href="{{Route('list-bunga')}}">Table Bunga</a></li>
            </ul>
            </li>
            <li>
              <a class="ai-icon" href="{{Route('list-history')}}" aria-expanded="false">
